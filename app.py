...
.polaroid-img { width: 400px; height: 200px; position: absolute; box-shadow: 0 5px 10px rgba(0,0,0,0.5); }
...
if st.session_state.stage == "landing":
    ...
    .love1 { top: 250px; right: -25px; transform: rotate(0deg); }
    .love2 { top: 350px; right: 100px; transform: rotate(0deg); }
    .love3 { top: 500px; right: 100px; transform: rotate(0deg); }
    .love4 { top: 750px; right: 100px; transform: rotate(0deg); }
    ...
    <div class="love-script love4">This is for the best Boyfriend in the world</div>
    """, unsafe_allow_html=True)
