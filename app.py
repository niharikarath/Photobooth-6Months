...
# ---------- Capture Page ----------
    ...
    # ---------- Photo Strip Preview ----------
    cols = st.columns(2, gap="large")  # use a larger gap so images aren't cramped
    for i in range(4):
        with cols[i]:
    ...
    cam_file = st.camera_input(
        ...
        key="camera_input",
        width=1850  # adjust preview size
    )
